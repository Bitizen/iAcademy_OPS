  ...
  <div id="empViewMyProfileDiv">
    ...
    <form class="form-horizontal" action="<?php echo base_url();?>index.php/EmployerController/updateRepresentative" method="POST">
    <fieldset>
     ...
     <?php echo form_open("auth/change_password");?>
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            <div class="form-group">
            <div class="col-lg-10">
              <label for="inputCompanyName" class="control-label">Old Password</label>
              <input type="password" value="" class="editbox form-control" id="old" name="old" size="20" />
              </div>
            <div class="form-group">
            <div class="col-lg-10">
              <label for="inputCompanyName" class="control-label">New Password</label><?php echo " (must be at least 8 characters)";?>
              <input type="password" value="" class="editbox form-control" id="new" name="new" size="20" />

              </div>
            <div class="form-group">
            <div class="col-lg-10">
              <label for="inputCompanyName" class="control-label">Confirm Password</label>
              <input type="password" value="" class="editbox form-control" name="new_confirm" id="new_confirm" pattern="^.{8}.*$" si_ze="20" />
              </div>
