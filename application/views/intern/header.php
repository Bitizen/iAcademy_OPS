...
<div class="navbar navbar-default">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo base_url();?>index.php/intern_controller">iACADEMY Online Placement System</a>
  </div>
  <div class="navbar-collapse collapse navbar-responsive-collapse">
    <ul class="nav navbar-nav">
      <li><a href="<?php echo base_url();?>index.php/intern_controller/viewMyAccount">My Account</a></li>
      <li><a href="<?php echo base_url();?>index.php/intern_controller/viewMyEmployer">Employer</a></li>
